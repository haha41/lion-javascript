...
// 2. 두 수의 합 더하기
// 3. 화면 출력 하기
const first = getNode('#firstNumber'); // 첫 번째 인풋
const second = getNode('#secondNumber'); // 두 번째 인풋
const result = getNode('.result');

function handleInput(){
  // let firstValue = Number(first.value); // 10 + 10 = 1010 안되게 숫자로 변환
  let firstValue = +first.value; // 암시적 형변환
  let secondtValue = second.value / 1;
  let total = firstValue + secondtValue;
...
// [page-2]
// clear 버튼을 누르면 모든 글자가 초기화 될 수 있도록 만들어 주세요
