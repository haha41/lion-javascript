...
class Tiger extends Animal {
  ...
  #prey = ''; // 숨김처리 -> beom.prey 치면 undefined, 클래스 안에서는 사용 가능!

  constructor(name, pattern) {
    super(name) // super : 내 부모의 프로퍼티를 가져다 쓰겠다 -> super(name) => this.name = name;)
  ...
  static sleep(name) {
    console.log(name + ' 이 잠을 잔다.'); // static -> Tiger 자체가 가지는 스태틱 메서드
  }
}
