...
// const a = button() // 값을 리턴, 값이 없으면 undefined

// const b = new Button() // b = {} -> 함수를 통해 객체를 만들 수 있다. constructor를 갖고 있기 때문에
...
// 함수 표현식
const expressiongFunction = function () {
  // console.log(this);
}

// window.expressiongFunction()
...
// 메서드 안에서 함수를 호출할 대는 화살표 함수가 더 좋나? yes
