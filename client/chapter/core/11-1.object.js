...
// const user2 = createUser('희소', 'happy@naver.com');


// 프로퍼티 포함 여부 확인

// key in user1 (-> 조상까지 찾게 됨)
...
// console.log(valueArray); // ['user-id-zQsadkq&1231', 'beom', 'seonbeom2@gamil.com', true, 'paid']
...
function deletProperty(object, key) {
  delete object[key];
  return object;
}
...
// 너 오브젝트가 비어있어? -> 비어 있으면 true, 비어있지않으면 false를 반환해줘
// function isEmptyObject(object) {
...
// 객체의 구조 분해할당: 순서가 정해져있지 않다. 변수의 이름을 바꿀 수 있을까? yes
