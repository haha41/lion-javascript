...
function calcPrice(
  ...
  // priceC ||= 0; // priceC의 값이 없으면 0을 할당
  // priceC ??= 0;

  // if(!priceC) priceC = 0; // undefined는 false, !false -> true
  ...
  if(!priceA || !priceB) {
    throw new Error('calcPrice 함수의 첫 번와 두 번째 매개변수는 필수 입력 값입니다.') //throw -> 콘솔창에 에러 표시
  }
...
/* 다음 함수를 작성해봅니다. -------------------------------------------------- */
// pxValue에 숫자 또는 문자가 옴. rem 함수의 반환타입은 string이다.
