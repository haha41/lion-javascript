...
// iterable(반복 가능한) = String, Array, Arry-like(유사배열-배열처럼 생겼는데 배열은 아님)
...
// 배열에는 인덱스와 length가 있다!
// 인데스 [ ]
// length



// languages는 배열이다. (배열안에 객체도 가능 -> [{}])
const languages = [
  {
    id: 'ecma-262',
    name: 'JavaScript',
...
for(let key in randomUser){
  // console.log(randomUser[key]); 이렇게 찾으면 조상까지 찾게 되서 안됨
...
// console.log(Object.key(randomUser)); // 모든 키값을 배열로 반환
