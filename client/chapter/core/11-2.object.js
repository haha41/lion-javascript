...
const copyObject = Object.assign({}, messenger) // 빈 객체를 만들고 copyObject에 메신저를 전달하겠다.
...
// 4. 객체를 복사해주는 유틸 함수 
// copdieObject는 object를 매개변수로 받고, Object의 assign을 통해서 전달받은 오브젝트를 복사해서 값을 반환하는 함수다
...
// 1. 깊은 복사 유틸리티 함수 // 재귀함수 cloneDeep을 또 호출
